...
var file_rpc_worker_proto_depIdxs = []int32{
	...
	8,  // 8: Worker.AssignMap:output_type -> WorkerAck
	8,  // 9: Worker.AssignReduce:output_type -> WorkerAck
	8,  // 10: Worker.HealthCheck:output_type -> WorkerAck
